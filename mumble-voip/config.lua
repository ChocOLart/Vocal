mumbleConfig = {
    voiceModes = {
        {5.5, "Chuchotement"}, -- Whisper speech distance in gta distance units
        {16, "Normal"}, -- Normal speech distance in gta distance units
        {34, "Crier"}, -- Shout speech distance in gta distance units
    },
